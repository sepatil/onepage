...
<head>
    ...
    <title>MUSTERTWO - Multipurpose One Page Website Tempplate</title>
...
<body data-spy="scroll" data-target="#myScrollspy" data-offset="1">
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="navbar-nav ml-auto" id="myScrollspy">
                    <p>Menu</p>
                    <li class="nav-item">
        ...
        <div class="container">
            <a class="navbar-brand" href="#">MUSTER-TWO</a>
    ...
    <section class="site-footer">
        <div class="container">
            <p class="text-center"><a href="#">&copy;2019 MUSTERTWO</a></p>
